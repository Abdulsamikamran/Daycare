...
import { Check, Building2, User2 } from "lucide-react";
    ...
    <Layout heading={"Select Role"}>
      ...
      <div className="flex gap-4 mb-8">
        ...
        <button
          ...
          className={`relative flex items-center text-[18px] font-medium h-[108px] w-[269px] justify-center gap-2 px-6 py-3 rounded-full transition-all duration-200 ${
